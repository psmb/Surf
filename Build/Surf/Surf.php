...
$workflow->defineTask('sfi.sfi:clearopcache',
        'typo3.surf:shell',
        array('command' => 'cd {currentPath}/Web && echo "<?php opcache_reset();" > cc.php && curl "http://' . $envVars['DOMAIN'] . '/cc.php" rm cc.php && cd {releasePath} && && FLOW_CONTEXT=Production ./flow flow:cache:flush --force && FLOW_CONTEXT=Production ./flow flow:cache:warmup')
);
// Simple smoke test
