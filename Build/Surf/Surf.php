...
$workflow->defineTask('sfi.sfi:clearopcache',		
        'typo3.surf:shell',		
        array('command' => 'cd {currentPath}/Web && echo "<?php opcache_reset(); echo \"cache cleared\";" > cc.php && curl "http://' . $envVars['DOMAIN'] . '/cc.php" && rm cc.php && FLOW_CONTEXT=Production ./flow flow:cache:flush --force')		
);
